...
>> Frequentist view give the result of the observation, while Bayesian statistics assumes a random distribution of possible results, and generating a distrituion of them based on obervations.
